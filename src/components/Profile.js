...
return(
    <div className="container">
        ...
        {console.log(psrc)}
       { psrc===null || psrc===undefined || psrc==="" ?<img src="https://firebasestorage.googleapis.com/v0/b/cyduck-3be89.appspot.com/o/images%2Fprofile1.jpg?alt=media&token=52193340-cd44-425d-9484-6fc68b7466a9" className="mainprofile"  alt="no-image"  />:<img src={psrc} className="mainprofile"  alt="no-image"  />}
